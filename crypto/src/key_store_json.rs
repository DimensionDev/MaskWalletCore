...
mod tests {
    ...
    fn test_import_keystore_json() {
        ...
        assert_eq!(key_store_json_struct.id, "3198bc9c-6672-5ab3-d995-4942343ae5b6");
        assert_eq!(key_store_json_struct.version, 3);
        assert_eq!(key_store_json_struct.crypto.cipher, "aes-128-ctr");
        assert_eq!(key_store_json_struct.crypto.cipherparams.iv, "83dbcc02d8ccb40e466191a123791e0e");
        ...
        assert_eq!(scrypt_param.salt, "ab0c7876052600dd703518d6fc3fe8984592145b591fc8fb5c6d43190334ba19");
        assert_eq!(key_store_json_struct.crypto.ciphertext, "d172bf743a674da9cdad04534d56926ef8358534d458fffccd4e6ad2fbde479c");
        assert_eq!(key_store_json_struct.crypto.kdf, "scrypt");
        assert_eq!(key_store_json_struct.crypto.mac, "2103ac29920d71da29f15d75b4a16dbe95cfd7ff8faea1056c33131d846e3097");
    }
}
